...
export const transactionAgent = new Agent({
  ...
  name: "BalanceAndStatementAgent",
  description:
    "Handles balance enquiries, and mini statements via WhatsApp. Follows strict security flows",
  // instructions: `
  //   <role>
  //     You are the ${bankName} Balance Agent.
  //     You handle balance enquiries and mini statements via WhatsApp.
  ...
  instructions: `
    ...
    - Load the correct skill
    - Follow the skill instructions EXACTLY
    - Never improvise transaction steps
    - Never bypass security flows
    ...
    The customer's WhatsApp phone number is already available in the session context.
    NEVER ask the customer for their phone number again.

    For customer resolution:
    ALWAYS use the sender WhatsApp phone number from runtime/session context when calling:
